designDictionary  = {'did not', 'last', 'uncomfortable', 'durable', 'comfort', 'tear', 'tips', 
...
valueDictionary   = {'price', 'expensive', 'cheaper', 'cheap', 'money', 'cost'}
batteryDictionary = { 'last', 'day', 'life', 'battery life', 'charge', 'short', 'batteries'}
audioDictionary   = {'bass', 'sharp' ,'shrill', 'noise', 'noise cancellation', 'sound', 'sound quality',
...
callDictionary    = {'hear', 'person', 'speak', 'words', 'break', 'not clear', 'disconnect', 'call', 'call drop',
                     'call', 'drop', "can't hear", 'mic', 'muffled', 'hear properly'
                    }
connectivityDict  = {'disconnect', 'drop', 'connect', 'connection', 'bluetoothh', 'pair', 'phone', 'android', 'iphone'
